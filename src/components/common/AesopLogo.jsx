const AesopLogo = () => {
  return (
    <div className="">
      <svg
        aria-label="Aesop"
        className="Icon_base__GKZ58 Icon_light__1TZsq Logo_icon__NDEf8 hidden lg:flex"
        height="40"
        width="120"
      ...
      <svg
        aria-labelledby="aesop-:r2f:"
        className="Icon_base__GKZ58 Icon_light__1TZsq Logo_icon__NDEf8 max-lg:flex hidden"
        datatestid="data-testid-Icon"
        focusable="false"
        height="30"
        role="img"
        tabIndex="-1"
